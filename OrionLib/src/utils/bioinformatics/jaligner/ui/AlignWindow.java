...
import utils.bioinformatics.jaligner.example.Example;
import utils.bioinformatics.jaligner.formats.CLUSTAL;
import utils.bioinformatics.jaligner.formats.FASTA;
import utils.bioinformatics.jaligner.formats.FormatFactory;
...
import utils.bioinformatics.jaligner.ui.clipboard.ClipboardListener;
import utils.bioinformatics.jaligner.ui.clipboard.ClipboardPoller;
...
import utils.bioinformatics.jaligner.ui.images.ToolbarIcons;
import utils.bioinformatics.jaligner.ui.logging.DocumentHandler;
import utils.bioinformatics.jaligner.ui.util.TextComponentUtil;
import utils.bioinformatics.jaligner.ui.util.TextComponentUtilException;
...
public class AlignWindow extends javax.swing.JFrame	implements
																										ClipboardListener,
																										DocumentListener
{
	/**
	...
	public AlignWindow()
	{
		...
		// Add actions
		jTextAreaSequence1.getInputMap().put(	KeyStroke.getKeyStroke("TAB"),
																					nextFocusAction.getClass().getName());
		jTextAreaSequence1.getActionMap().put(nextFocusAction.getClass().getName(),
																					nextFocusAction);
		jTextAreaSequence1.getInputMap().put(	KeyStroke.getKeyStroke("shift TAB"),
																					prevFocusAction.getClass().getName());
		jTextAreaSequence1.getActionMap().put(prevFocusAction.getClass().getName(),
																					prevFocusAction);

		jTextAreaSequence2.getInputMap().put(	KeyStroke.getKeyStroke("TAB"),
																					nextFocusAction.getClass().getName());
		jTextAreaSequence2.getActionMap().put(nextFocusAction.getClass().getName(),
																					nextFocusAction);
		jTextAreaSequence2.getInputMap().put(	KeyStroke.getKeyStroke("shift TAB"),
																					prevFocusAction.getClass().getName());
		jTextAreaSequence2.getActionMap().put(prevFocusAction.getClass().getName(),
																					prevFocusAction);
	...
	{// GEN-BEGIN:initComponents
		...
		jPopupOpen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_O,
		...
		jPopupSave.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_S,
																																	java.awt.event.InputEvent.CTRL_MASK));
		...
		jPopupCopy.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_C,
																																	java.awt.event.InputEvent.CTRL_MASK));
		...
		jPopupPaste.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V,
																																	java.awt.event.InputEvent.CTRL_MASK));
		...
		jPopupDelete.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_DELETE,
																																		0));
		...
		jPopupPrint.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P,
																																	java.awt.event.InputEvent.CTRL_MASK));
		...
		jPopupSelectAll.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A,
																																			java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemFileOpen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O,
																																				java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemFileLoadSequence1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_1,
																																									java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemFileLoadSequence2.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_2,
																																									java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemFileLoadMatrix.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M,
																																							java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemFilePrint.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_P,
																																					java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemEditCut.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_X,
																																				java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemEditCopy.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C,
																																				java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemEditPaste.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_V,
																																					java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemEditDelete.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_DELETE,
																																					0));
		...
		jMenuItemEditSelectAll.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_A,
																																							java.awt.event.InputEvent.CTRL_MASK));
		...
		jMenuItemToolsRunExample.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_F5,
																																								0));
		...
		jMenuItemAbout.setAccelerator(javax.swing.KeyStroke.getKeyStroke(	java.awt.event.KeyEvent.VK_F1,
																																			0));
	...
	{// GEN-FIRST:event_exitForm
		...
		if (JOptionPane.showConfirmDialog(this,
																			"Are you sure you want to exit JAligner?",
																			"JAligner - confirmation",
	 ...
	 * @param items
	 *          array of strings to be added to the combobox
	 * @param selected
