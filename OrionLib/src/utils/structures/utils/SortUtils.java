package utils.structures.utils;
...
public class SortUtils
{
																																		...
																																		Comparator<List<O>>
	{
		...
		public ListComparator(final int pColumn, final boolean pAscendingOrder)
		{
			...
			this.mAscendingOrder = pAscendingOrder;
		}

		public int compare(final List<O> pO1, final List<O> pO2)
		{
			final O lComparable1 = pO1.get(this.mColumn);
			final O lComparable2 = pO2.get(this.mColumn);
			return (this.mAscendingOrder ? 1 : -1) * lComparable1.compareTo(lComparable2);
		}
	}
