...
public final class ClinchingAnalysis
{
	...
	public ClinchingAnalysis(final String pGeometryFileName)
	{
		try
		{
			...
			final boolean lFoundP01 = (mP01 = searchPoint(lSearchTopSheet,
																										"P01",
																										0,
																										lPointPatternP0)) != null;
			mIndexP01 = (int) (mP01.getCoordinate(0)) - 1;

			final PatternExtremumX lPatternPB1 = new PatternExtremumX("maximum",
																																"forwards");

			lSearchTopSheet.positiveDirection();
			final boolean lFoundPB1 = (mPB1 = searchPoint(lSearchTopSheet,
																										"PB1",
																										mIndexP01,
																										lPatternPB1)) != null;
			mIndexPB1 = (int) mPB1.getCoordinate(0) - 1;

			final PatternExtremumX lPatternPA1 = new PatternExtremumX("minimum",
																																"forwards");

			final boolean lFoundPA1 = (mPA1 = searchPoint(lSearchTopSheet,
																										"PA1",
																										mIndexPB1,
																										lPatternPA1)) != null;
			...
			final boolean lFoundPAp = (mPAp = searchPoint(lSearchTopSheet,
																										"PAp",
																										mIndexP01,
																										lPatternPAp)) != null;
			...
			final boolean lFoundP02 = (mP02 = searchPoint(lSearchBottomSheet,
																										"P02",
																										0,
																										lPointPatternP0)) != null;
			...
			final PatternExtremumX lPatternPB2 = new PatternExtremumX("maximum",
																																"backwards");

			final boolean lFoundPB2 = (mPB2 = searchPoint(lSearchBottomSheet,
																										"PB2",
																										mIndexP02,
																										lPatternPB2)) != null;
			...
			final PatternExtremumX lPatternPA2 = new PatternExtremumX("minimum",
																																"backwards");

			final boolean lFoundPA2 = (mPA2 = searchPoint(lSearchBottomSheet,
																										"PA2",
																										mIndexPB2,
																										lPatternPA2)) != null;
			...
			final boolean lFoundPC2 = (mPC2 = searchPoint(lSearchTopSheet,
																										"PC2",
																										mIndexP01,
																										mPatternPC2)) != null;
																					...
																					final SearchPointList.PointPattern pPattern)
	{
		...
		if (lPointIndex > 0)
		{
			...
			final GeometryFile.Point pPoint = pSearchPointList.getPointList()
																												.getPointAt(lPointIndex);
	...
	private final SearchPointList.PointPattern mPatternPC2 = new SearchPointList.PointPattern()
	{
		...
		public boolean conditionOnPointCurrent(GeometryFile.Point pPoint)
		{
			...
			if (SearchPointList.isGreaterTol(lX, mPB2.getCoordinate(1), mTol))
			{
				mPreB1 = mYMinimum;
				return true;
			}
	 ...
	 * @return
	 */
	private double distance(final GeometryFile.Point pPoint1,
													final GeometryFile.Point pPoint2)
	{
