...
public class Arrays
{
	...
	private static void sort2(double a[], int fromIndex, int toIndex)
	{
		...
		/*
		 * The sort is done in three phases to avoid the expense of using NaN and
		 * -0.0 aware comparisons during the main sort.
		 */

		/*
		 * Preprocessing phase: Move any NaN's to end of array, count the number of
		 * -0.0's, and turn them into 0.0's.
		 */
		int numNegZeros = 0;
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	short[] a,
																		int fromIndex,
																		int toIndex,
																		short key)
	{
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	char[] a,
																		int fromIndex,
																		int toIndex,
																		char key)
	{
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	byte[] a,
																		int fromIndex,
																		int toIndex,
																		byte key)
	{
	 ...
	 * using the binary search algorithm. The range must be sorted (as by the
	 * {@link #sort(double[], int, int)} method) prior to making this call. If it
	 * is not sorted, the results are undefined. If the range contains multiple
	 * elements with the specified value, there is no guarantee which one will be
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	double[] a,
																		int fromIndex,
																		int toIndex,
																		double key)
	{
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	float[] a,
																		int fromIndex,
																		int toIndex,
																		float key)
	{
	...
	// Like public version, but without range checks.
	private static int binarySearch0(	Object[] a,
																		int fromIndex,
																		int toIndex,
																		Object key)
	{
	 ...
	 *          may lie outside the array.)
	 * @return a new array containing the specified range from the original array,
	 *         truncated or padded with false elements to obtain the required
	 *         length
	 * @throws ArrayIndexOutOfBoundsException
	 *           if <tt>from &lt; 0</tt> or <tt>from &gt; original.length()</tt>
	 * @throws IllegalArgumentException
	 ...
	 * {@link List} containing a sequence of {@link Long} instances representing
	 ...
	 * to one another. Unlike the {@link #equals(Object[],Object[])} method, this
