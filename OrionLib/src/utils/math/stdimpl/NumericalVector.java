...
public class NumericalVector extends Object	implements
																						IVectorArray,
																						INumericalVector
{
	...
	/**
	 * @see utils.math.INumericalVector#toZero()
	 */
	public void toZero()
	{
	...
	{
		final int lMaxDimension = Math.max(	pVect.getDimension(),
																				this.getDimension());
	...
	/**
	 * @see utils.math.INumericalVector#normalizeEquals()
	 */
	...
	/**
	 * @see utils.math.INumericalVector#angleWith(org.royerloic.math.stdimpl.NumericalVector)
	 */
