...
public class negative_binomial
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double n, double p);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double cumulative(double x, double n, double p);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double quantile(double x, double n, double p);
	 * 
	 * DESCRIPTION
	 * 
	 * The distribution function of the negative binomial distribution.
	 ...
	 * REFERENCE
	 * 
	 * Devroye, L. (1980). Non-Uniform Random Variate Generation. New
	 * York:Springer-Verlag. Page 480.
	 * 
	 * METHOD
	 * 
	 * Generate lambda as gamma with shape parameter n and scale parameter
