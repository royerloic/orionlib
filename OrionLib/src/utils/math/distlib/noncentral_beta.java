...
public class noncentral_beta
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double a, double b, double
	 * lambda);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * psum = p(0) + ... + p(k)
	 * 
	 * is close to 1. Here we continue until 1 - psum < epsilon, with epsilon set
	...
	/*
	 * Algorithm AS 226 Appl. Statist. (1987) Vol. 36, No. 2 Incorporates
	 * modification AS R84 from AS Vol. 39, pp311-2, 1990
	 * 
	 ...
	 * 
	 * Auxiliary routines required: lgamma - log-gamma function pbeta -
