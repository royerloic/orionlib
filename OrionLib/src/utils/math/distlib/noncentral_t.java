...
public class noncentral_t
{
	 ...
	 * 
	 * Cumulative probability at t of the non-central t-distribution with df
	 * degrees of freedom (may be fractional) and non-centrality parameter delta.
	 * 
	 * NOTE
	 * 
	 * Requires the following auxiliary routines:
	 * 
	 * lgammafn(x) - log gamma function beta.cumulative(x, a, b) - incomplete beta
	 * function normal.cumulative(x) - normal distribution function
	 * 
	 * CONSTANTS
	 * 
