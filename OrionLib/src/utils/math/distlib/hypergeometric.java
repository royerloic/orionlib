...
public class hypergeometric
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double NR, double NB, double
	 * n);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double cumulative(double x, double NR, double NB,
	 * double n);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(double NR, double NB, double n);
	 * 
	 * DESCRIPTION
	 * 
	 * Random variates from the hypergeometric distribution. Returns the number of
	 * white balls drawn when kk balls are drawn at random from an urn containing
	 * nn1 white and nn2 black balls.
	 * 
	 * REFERENCE
	 * 
	 * V. Kachitvichyanukul and B. Schmeiser (1985). ``Computer generation of
	 * hypergeometric random variates,'' Journal of Statistical Computation and
															...
															uniform PRNG)
	{
		...
		if (minjx == maxjx)
		{
			...
			ix = maxjx;
			/*
			 * return ix; No, need to unmangle <TSL>
			 */
