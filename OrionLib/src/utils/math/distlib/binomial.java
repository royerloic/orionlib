...
public class binomial
{
	 ...
	 * NOTES
	 * 
	 * The function uses the Cornish-Fisher Expansion to include a skewness
	 * correction to a normal approximation. This gives an initial value which
	 * never seems to be off by more than 1 or 2. A search is then conducted of
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(double nin, double pp)
	 * 
	 * DESCRIPTION
	 * 
					...
					else
					{
						...
						if (alv <= ynorm + amaxp)
						{
							...
							if (alv <= xm * java.lang.Math.log(f1 / x1)
													+ (n - m + 0.5)
													* java.lang.Math.log(z / w)
													+ (ix - m)
													* java.lang.Math.log(w * p / x1 * q)
