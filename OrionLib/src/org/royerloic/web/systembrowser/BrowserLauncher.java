package org.royerloic.web.systembrowser;

// originally this package was: "edu.stanford.ejalbert"
// found at http://browserlauncher.sourceforge.net/
// Thanks and credits go to to Steven Spencer and Eric Albert. 
		...
		switch (jvm)
		{
			...
			case MRJ_2_1:
				try
				{
					...
					final Field systemFolderField = mrjFileUtilsClass.getDeclaredField("kSystemFolderType");
	...
	private static Object locateBrowser()
	{
		...
		switch (jvm)
		{
			case MRJ_2_0:
				try
				{
					final Integer finderCreatorCode = (Integer) makeOSType.invoke(null, new Object[]
					{ FINDER_CREATOR });
					final Object aeTarget = aeTargetConstructor.newInstance(new Object[]
					{ finderCreatorCode });
					final Integer gurlType = (Integer) makeOSType.invoke(null, new Object[]
					{ GURL_EVENT });
			...
			case MRJ_2_1:
				...
				for (final String element : systemFolderFiles)
					try
					{
						...
						final Object fileType = getFileType.invoke(null, new Object[]
						{ file });
						if (FINDER_TYPE.equals(fileType.toString()))
						{
							final Object fileCreator = getFileCreator.invoke(null, new Object[]
							{ file });
							if (FINDER_CREATOR.equals(fileCreator.toString()))
							{
								browser = file.toString(); // Actually the Finder, but that's
								// OK
								return browser;
							}
						}
		...
		switch (jvm)
		{
			case MRJ_2_0:
				...
				try
				{
					...
					{ url });
					putParameter.invoke(lBrowser, new Object[]
					{ keyDirectObject, aeDesc });
					sendNoReply.invoke(lBrowser, new Object[]
					{});
				}
				catch (final InvocationTargetException ite)
				{
			...
			case WINDOWS_9x:
				...
				Process process = Runtime.getRuntime().exec(
						new String[]
						{ (String) lBrowser, FIRST_WINDOWS_PARAMETER, SECOND_WINDOWS_PARAMETER, THIRD_WINDOWS_PARAMETER,
								'"' + url + '"' });
			...
			case OTHER:
				...
				process = Runtime.getRuntime().exec(
						new String[]
						{ (String) lBrowser, NETSCAPE_REMOTE_PARAMETER,
