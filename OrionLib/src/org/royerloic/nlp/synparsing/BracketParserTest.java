...
public class BracketParserTest extends TestCase
{
	public void test1()
	{

		{
			...
			TextTree<String> lTextTree = new TextTree<String>(lAbstract);
	...
	public void testNesting()
	{
		...
		String lAbstract = "( 5' bla(TEM), bla[SHV], bla(CARB{19 - 0}), bla(CTX-\"Mdiuhdkjhd\"), bla(IMP), bla(VIM), bla(CphA/IMIS), bla(OXA-A), bla(OXA-B), bla(OXA-C))";
		TextTree<String> lTextTree = new TextTree<String>(lAbstract);
		BracketParser.markAll(lTextTree, "bracket");
