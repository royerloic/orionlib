...
public class RangeTest
{
	...
	public void testContiguousTo()
	{
		...
		// test that if there is a gap between the two ranges there is no contiguity.
...
/*
	...
	{
		final Range docRange = new Range(2);
		final List<Range> ranges = new ArrayList<Range>();
		Range.addDocRange(ranges, docRange);

		Assert.assertEquals(1, ranges.size());
		Assert.assertEquals(2, ranges.get(0).getStart());
		Assert.assertEquals(3, ranges.get(0).getEnd());
	}
	...
	public void testAddInBetween()
	{
		...
		Assert.assertEquals(1, ranges.size());
		Assert.assertEquals(1, ranges.get(0).getStart());
		Assert.assertEquals(4, ranges.get(0).getEnd());
	}
	...
	{
		final Range docRange = new Range(1);
		final List<Range> ranges = new ArrayList<Range>();
		ranges.add(new Range(1));
		...
		Assert.assertEquals(1, ranges.size());
		Assert.assertEquals(1, ranges.get(0).getStart());
		Assert.assertEquals(2, ranges.get(0).getEnd());
	}
	...
	{
		final Range docRange = new Range(3);
		final List<Range> ranges = new ArrayList<Range>();
		ranges.add(new Range(1));
		...
		Assert.assertEquals(3, ranges.get(1).getStart());
		Assert.assertEquals(4, ranges.get(1).getEnd());
	}
	...
	@Test
	public void testAddSuperRange()
	{
		final Range docRange = new Range(1, 5);
		final List<Range> ranges = new ArrayList<Range>();
		...
		Assert.assertEquals(1, ranges.size());
		Assert.assertEquals(1, ranges.get(0).getStart());
		Assert.assertEquals(6, ranges.get(0).getEnd());
	}


	@Test
	public void testAddSubRange()
	{
		final Range docRange = new Range(2, 3);
		final List<Range> ranges = new ArrayList<Range>();
	...
	@Test
	public void testMergeSuperAndSubRanges()
	{
		final List<Range> subRanges = new ArrayList<Range>();
		subRanges.add(new Range(2, 3));
		...
		Assert.assertEquals(1, superRanges.size());
		Assert.assertEquals(1, superRanges.get(0).getStart());
		Assert.assertEquals(6, superRanges.get(0).getEnd());

	}


	@Test
	public void testMergeOddAndEvenRanges()
	{
		final List<Range> oddRanges = new ArrayList<Range>();
		oddRanges.add(new Range(1));
		oddRanges.add(new Range(3));

		final List<Range> evenRanges = new ArrayList<Range>();
		evenRanges.add(new Range(2));
		evenRanges.add(new Range(4));
		evenRanges.add(new Range(6));

		Range.mergeBaseWithUpdate(oddRanges, evenRanges);

		Assert.assertEquals(2, oddRanges.size());
		Assert.assertEquals(1, oddRanges.get(0).getStart());
		Assert.assertEquals(5, oddRanges.get(0).getEnd());

		Assert.assertEquals(6, oddRanges.get(1).getStart());
		Assert.assertEquals(7, oddRanges.get(1).getEnd());
	}


	@Test
	public void testDocRangesExtraction()
	{
		final List<Integer> docIDs = new ArrayList<Integer>();
		docIDs.add(new Integer(1));
		docIDs.add(new Integer(3));
		docIDs.add(new Integer(5));
		docIDs.add(new Integer(6));
		docIDs.add(new Integer(7));
		docIDs.add(new Integer(9));

		final List<Range> docRanges = Range.buildRanges(docIDs);

		Assert.assertEquals(4, docRanges.size());

		Assert.assertEquals(1, docRanges.get(0).getStart());
		Assert.assertEquals(2, docRanges.get(0).getEnd());

		Assert.assertEquals(3, docRanges.get(1).getStart());
		Assert.assertEquals(4, docRanges.get(1).getEnd());

		Assert.assertEquals(5, docRanges.get(2).getStart());
		Assert.assertEquals(8, docRanges.get(2).getEnd());
	...
	@Test
	public void testSearchForSubRange()
	{
		final List<Range> ranges = new ArrayList<Range>();
	...
	@Test
	public void testSearchForContiguousRange()
	{
		final List<Range> ranges = new ArrayList<Range>();
		ranges.add(new Range(1, 2));
		ranges.add(new Range(5));

		final Range contRange1 = new Range(0);
		final Range contRange2 = new Range(3);
		final Range contRange3 = new Range(6);
	...
	@Test
	public void testSearchingForSuperRange()
	{
		final List<Range> ranges = new ArrayList<Range>();
		ranges.add(new Range(429));
		ranges.add(new Range(447, 451 - 447 + 1));
		ranges.add(new Range(740));
		ranges.add(new Range(1083));
		ranges.add(new Range(1637));
		ranges.add(new Range(4354));

		Assert.assertEquals(0, Range.getNearestRangeIndex(ranges, new Range(426, 432 - 426 + 1)));
	}


	@Test
	public void testSearchForNonExistingRange1()
	{
		final List<Range> ranges = new ArrayList<Range>();
		...
		final Range contRange1 = new Range(0);
		final Range contRange2 = new Range(4);
		final Range contRange3 = new Range(90);
	...
	@Test
	public void testSearchForNonExistingRange2()
	{
		final List<Range> ranges = new ArrayList<Range>();
		ranges.add(new Range(2));
		ranges.add(new Range(6));
		ranges.add(new Range(8));
	...
	@Test
	public void testCrashMergeEmptyAndChild()
	{
		final List<Range> childList = new ArrayList<Range>();
		for (int i = 1; i < 100000; i = i + 2)
		{
			childList.add(new Range(i));
		}
		final List<Range> empty = new ArrayList<Range>();
		// long start = System.currentTimeMillis();
		Range.mergeBaseWithUpdate(empty, childList);
	...
	@Test
	public void testCrashMergeParentAndChild()
	{
		final List<Range> childList = new ArrayList<Range>();
		final List<Range> parentList = new ArrayList<Range>();
		for (int i = 1; i < 100000; i = i + 2)
		{
			childList.add(new Range(i));
		}
		...
		// long start = System.currentTimeMillis();
		Range.mergeBaseWithUpdate(parentList, childList);
		// long end = System.currentTimeMillis();
