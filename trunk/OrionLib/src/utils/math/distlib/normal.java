...
public class normal
{
	...
	public static double density(double x, final double mu, final double sigma)
	{
		...
		x = (x - mu) / sigma;
		return Constants.M_1_SQRT_2PI * java.lang.Math.exp(-0.5 * x * x) / sigma;
	}

	/**
	 * DESCRIPTION The main computation evaluates near-minimax approximations
	 * derived from those in "Rational Chebyshev approximations for the error
	 * function" by W. J. Cody, Math. Comp., 1969, 631-637. This transportable
	 * program uses rational functions that theoretically approximate the normal
	 ...
	 * Special Function Routines and Test Drivers". ACM Transactions on
	 ...
	 * 
	 * For small to moderate probabilities, algorithm referenced below is used to
	 * obtain an initial approximation which is polished with a final Newton step.
	 * 
	 * For very large arguments, an algorithm of Wichura is used.
	 * 
	 * REFERENCE
	 * 
	 * Beasley, J. D. and S. G. Springer (1977). Algorithm AS 111: The percentage
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(double mu, double sigma, uniform PRNG );
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(void);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * sampling from the normal distribution. Math. Comput. 27, 927-937.
	 * 
	 ...
	 * random variables. JASA 71, 893-896.
	 */
