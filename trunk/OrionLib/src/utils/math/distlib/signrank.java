...
public class signrank
{
	...
	/*
	 * DistLib : A C Library of Special Functions Copyright (C) 1998 R Core Team
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double cumulative(double x, double n)
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double quantile(double x, double n);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(double n)
	 * 
	 * DESCRIPTION
	 * 
