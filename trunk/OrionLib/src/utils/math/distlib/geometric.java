...
public class geometric
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double p);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double quantile(double x, double p);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double random(double p);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * NOTES
	 * 
	 * We generate lambda as exponential with scale parameter p / (1 - p). Return
	 * a Poisson deviate with mean lambda.
	 * 
	 * REFERENCE
	 * 
	 * Devroye, L. (1980). Non-Uniform Random Variate Generation. New York:
