...
public class t
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double n);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double quantile(double p, double ndf);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * NOTES
	 * 
	 * This is a C translation of the Fortran routine given in: Algorithm 396:
	...
	public static double quantile(final double p, final double ndf)
	{
		...
		else
		{
			...
			{
				y = ((1 / (((ndf + 6) / (ndf * y) - 0.089 * d - 0.822) * (ndf + 2) * 3) + 0.5 / (ndf + 4)) * y - 1) * (ndf + 1)
						/ (ndf + 2)
						+ 1
						/ y;
			}
	 ...
	 * SYNOPSIS
	 * 
	 * #include "mathlib.h" double random(double df);
	 * 
	 * DESCRIPTION
	 * 
