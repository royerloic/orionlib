...
public class beta
{
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double density(double x, double a, double b);
	 * 
	 * DESCRIPTION
	 * 
	 ...
	 * SYNOPSIS
	 * 
	 * #include "DistLib.h" double cumulative(double x, double pin, double qin);
	 * 
	 * DESCRIPTION
	 * 
	 * Returns distribution function of the beta distribution. (The incomplete
	 * beta ratio).
	 * 
	 * NOTES
	 * 
	...
	/*
	 * R : A Computer Langage for Statistical Data Analysis Copyright (C) 1995,
	 * 1996 Robert Gentleman and Ross Ihaka
	 * 
	 * This program is free software; you can redistribute it and/or modify it
	 * under the terms of the GNU General Public License as published by the Free
	 * Software Foundation; either version 2 of the License, or (at your option)
	 ...
	 * 
	 * 
	 * Reference: Cran, G. W., K. J. Martin and G. E. Thomas (1977). Remark AS R19
	 * and Algorithm AS 109, Applied Statistics, 26(1), 111-114. Remark AS R83
	 * (v.39, 309-310) and the correction (v.40(1) p.236) have been incorporated
	 * in this version.
	 */
	...
	/*
	 * Reference: R. C. H. Cheng (1978). Generating beta variates with nonintegral
	 * shape parameters. Communications of the ACM 21, 317-322. (Algorithms BB and
	 * BC)
	 */
