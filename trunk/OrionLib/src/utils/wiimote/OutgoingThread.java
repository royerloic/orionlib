...
import utils.wiimote.request.MoteRequest;
...
class OutgoingThread extends Thread
{
	...
	protected OutgoingThread(String btaddress) throws IOException,
																						InterruptedException
	{
		super("OutgoingWiimoteThread:" + btaddress);
		outgoing = (L2CAPConnection) Connector.open("btl2cap://" + btaddress
