 ...
 */
package utils.wiimote.demos.gui;
...
public class MoteGui
{
	...
	protected class IRCompentent extends JPanel
	{
		...
		protected void paintComponent(Graphics g)
		{
			...
			AffineTransform trafo = AffineTransform.getScaleInstance(	1024 / getWidth(),
																																768 / getHeight());
	...
	private boolean[] leds = new boolean[]
