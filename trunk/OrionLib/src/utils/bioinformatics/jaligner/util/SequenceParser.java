...
package utils.bioinformatics.jaligner.util;
...
/**
 * SequenceParser to sequences from different formats. <br>
...
public class SequenceParser
{
	...
	public static Sequence parse(String sequence) throws SequenceParserException
	{
		...
		if (sequence.startsWith(">"))
		{
			...
			sequenceDescription = index + 1 > first.length() ? ""
	...
	public static Sequence parse(File file) throws SequenceParserException
	{
		...
		try
		{
			...
			if (line.startsWith(">"))
			{
				...
				sequenceDescription = index + 1 > line.length()	? ""
